...
export default function Hero() {
  return (
    <section className="relative -mt-16 bg-ink">
      ...
      <div className="relative w-full pb-3.5 pt-[88px] sm:pt-[100px]">
        <div className="container-page relative">
          <div className="max-w-2xl text-white animate-fade-in">
            ...
            <p className="mt-2.5 max-w-xl text-[15px] leading-snug text-white/85 sm:text-lg sm:leading-normal">
              Коттеджи, гостевые дома и пансионаты напрямую от владельцев.
              Проверенные варианты, честные цены и быстрое бронирование на
              Иссык-Куле.
            </p>

            {/* Trust items — 3 в одну строку; на mobile только icon + title (макет) */}
            <div className="mt-4 grid grid-cols-3 gap-2 sm:mt-5 sm:gap-5">
              {TRUST.map((t) => (
                <div
                  key={t.title}
                  className="flex items-center gap-2 sm:items-start sm:gap-2.5"
                >
                  ...
                  <span className="min-w-0">
                    ...
                    <span className="mt-0.5 hidden text-xs text-white/70 sm:block">
                      {t.text}
                    </span>
                  </span>
                </div>
